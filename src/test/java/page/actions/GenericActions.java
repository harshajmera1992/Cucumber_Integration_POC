...
public class GenericActions {
	...
	public static void click_on_tab(String tab) throws InterruptedException{
		Thread.sleep(6000);
		WaitHelper.waitForElementPresence(GenericActionsObjects.ALL_TABS, 20); 
		ButtonHelper.click(GenericActionsObjects.ALL_TABS); 
	}
	...
	public static void click_on_button(String button) throws InterruptedException{
		...
		if(button.equalsIgnoreCase("New")){
			Thread.sleep(4500);  
			WaitHelper.waitForElementPresence(By.xpath("//input[@name='new']"), 20);
			ButtonHelper.click(By.xpath("//input[@name='new']")); 
	...
	public static void executeAnonymous(String query) throws ConnectionException{
		...
		apiUtil.setPassword(ExcelDataReader.setSoapCreds(PathConstants.SAMPLEDATA_PATH, "SoapCredentials").get("AdminPassword"));
		apiUtil.setAuthEndPoint(ExcelDataReader.setSoapCreds(PathConstants.SAMPLEDATA_PATH, "SoapCredentials").get("AuthEndPoint"));
		apiUtil.setConnectorConfig(apiUtil.getUsername(), apiUtil.getPassword(), apiUtil.getAuthEndPoint());
		apiUtil.setPartnerConnection(apiUtil.getUsername(), apiUtil.getPassword(), apiUtil.getAuthEndPoint());
