...
@CucumberOptions(features = { "classpath:featurefile/Opportunity_1.feature" }, 
...
strict = false
,monochrome = true)
@Listeners({helper.jiraUtils.TestListener.class})
public class OpportunityRunner_1  extends AbstractTestNGCucumberTests {
